    ...
    <div class="page">
        ...
        <div class="main-page">
            <div class="photo-gallery">
                <div class="title">
                    <h3>Foto Penanaman</h3>
                </div>
                <div class="photo-flex">
                    <div class="flex-column">
                        <img src="../img/kegiatan/bibit1.jpg" alt="">
                        <img src="../img/kegiatan/bibit2.jpg" alt="">
                    </div>
                    <div class="flex-column">
                        <img src="../img/kegiatan/bibit3.jpg" alt="">
                        <img src="../img/kegiatan/bibit4" alt="">
                    </div>
                </div>
            </div>
        </div>
